...
gnome-terminal --working-directory=${path} -- roslaunch ur_robot_driver ur10_bringup.launch robot_ip:=172.31.1.115 #192.168.56.101 # #kinematics_config:=${path}/../../my_robot_calibration.yaml
