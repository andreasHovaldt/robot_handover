...
class UR_python_interface():
    ...
    def go_to_pose_goal(self):
        ...
        #if (not all_close(pose_goal, current_pose, 0.01)):          RYK TILBAGE EFTER TEST 14-12 2022
        success = move_group.go(wait=True) #RYK TILBAGE EFTER TEST 14-12 2022
        # Calling `stop()` ensures that there is no residual movement
        move_group.stop()    #RYK TILBAGE EFTER TEST 14-12 2022
