...
class robot_controller():
    ...
    # Function used to update joint angles from message
    def joint_callback(self, msg):
        self.jnts[0] = msg.jnt1
        self.jnts[1] = msg.jnt2
        self.jnts[2] = msg.jnt3
        self.jnts[3] = msg.jnt4
        self.jnts[4] = msg.jnt5
        self.jnts[5] = msg.jnt6
...
def main():
    ...
    if not rospy.is_shutdown():
        robot_control.reset_joint_state()
    
    while not rospy.is_shutdown():
        try:
            
            
            # rospy.Subscriber("joint_angles",joint_angles,callback=robot_control.joint_callback)
